...
$resourceJs = [
    ...
    'js/scripts.bundle.js?rand=' . random_int(1, 99),
    'js/app.js?rand=' . random_int(1, 99),
];
if (config('app.debug') === true) //Adiciona script de facilidades de debug - Não deve ir em producaos
    $resourceJs[] = 'js/debugutils.js?rand=' . random_int(1, 99);
...
return [
    ...
    'resources' => [
        ...
        'css' => [
            ...
            'css/style.bundle.css?rand=' . random_int(1, 99),
        ],
        'js' => $resourceJs,
    ],
