...
// Default
mix.js('resources/js/app.js', 'public/js').scripts('resources/js/debugutils.js', 'public/js/debugutils.js').scripts('resources/js/config.js', 'public/js/config.js').sass('resources/sass/app.scss', 'public/css');
